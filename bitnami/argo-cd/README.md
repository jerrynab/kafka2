...
| `image.tag`         | Argo CD image tag (immutable tags are recommended)                                                      | `2.5.3-debian-11-r0` |
...
| `dex.image.tag`                                         | Dex image tag (immutable tags are recommended)                                                      | `2.35.3-debian-11-r15` |
...
| `redis.image.tag`                         | Redis image tag (immutable tags are recommended)                                                      | `7.0.5-debian-11-r23` |
